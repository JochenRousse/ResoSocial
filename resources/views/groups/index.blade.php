    ...
    <div class="col-md-10">
        <div class="view-container container">
            <form class="form-inline" method="POST" action="{{ route('group.create') }}">
                ...
                <div class="form-group">
                    <div class="col-md-6">
                        <select class="form-control" name="group_private">
            ...
            @endif
            <h1>Demandes d'ajout à mes groupes</h1>
            ...
            @else
                <div class="alert alert-info" role="alert"><span class="glyphicon glyphicon-info-sign"></span> Aucune
                    demande.
                </div>
            @endif
        </div>
